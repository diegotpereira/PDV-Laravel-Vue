<html>
    ...
    <body>
        <table class="printer-ticket">
            <thead>
                <tr>
                    <th class="title" colspan="3">{{ env('NOTA_NAME')}}</th>
                </tr>
                <tr>
            ...
            <tfoot>
                ...
                <tr class="sup">
                    <td colspan="3" align="center">
                        @if(env('NOTA_ADDRESS') !== null)
                        {{env('NOTA_ADDRESS')}}<br>
                        @endif 
                        @if(env('NOTA_PHONE') !== null)
                        Telefone: {{ env('NOTA_PHONE')}}
                        @endif 
                        @if(env('NOTA_CNPJ') !== null)
                        | CNPJ: {{env('NOTA_CNPJ')}}<br>
                        @endif 
