...
<div id="tocopy" style="display: none;">
    <div>
        ...
        <div class="row" style="border-bottom: solid 1px;padding:5px;margin-bottom:15px">
           <div class="col-md-12">
    ...
    <form id="vendaForm" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <input id="total_pagar" name="total" data-mask="000.000,00" data-mask-reverse="true" class="form-control"/>
            </div>
            <div class="col-md-2 col-md-offset-2">
                <label>Pg. em dinheiro e crédito: </label>
                <input id="dividir" oninput="$(this).trigger('change');" name="dividir" value="true" type="checkbox"/>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2 col-md-offset-2">
                ...
                <input id="val_recebido" name="valor_dinheiro" data-mask="000.000,00" data-mask-reverse="true" class="form-control" />
            </div>
            <div class="col-md-2">
                <label>Troco: </label>
                <input id="troco" name="troco" data-mask="000.000,00" data-mask-reverse="true" class="form-control" readonly/>
            </div>
        </div>
        <button class="btn btn-success" type="submit"
            <?php if(!$aberto) echo 'disabled';?> >Enviar
        </button>
    </form>
</div>
@stop 
