    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nome" required="required" name="nome" class="form-control" placeholder="Nome do Produto" aria-describedby="basic-addon1" />
            </div>
            <div class="form-group">
                <label for="descricao">Descrição do Produto</label>
                <input type="text" id="descricao" required="required" name="descricao" class="form-control" placeholder="Descrição do Produto" aria-describedby="basic-addon1" />
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="estoque">Estoque</label>
                    <input type="number" id="estoque" required="required" name="estoque" class="form-control" placeholder="Quantidade no estoque" aria-describedby="basic-addon1" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
