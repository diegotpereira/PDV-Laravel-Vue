...
<div class="row">
    <div class="row">
        <div class="col-md-8">
            <button class="btn btn-default editar">Editar
                <span class="glyphicon glyphicon-edit"></span>
            </button>
            <button class="btn btn-default excluir">excluir
    ...
    $(function() {
        ...
        function navigate(m) {
            ...
            if (m > 0) {
                ...
                table.ajax.url(prevp).load(loadtable, true);
        }
            ...
            if (confirm("Deseja realmente apagar esse registro?")) {
                $.post("{{ route('estoque.api.delete')}}", {
                    ...
                    if (data.success == true) {
                        ...
                        alert("Não foi possível apagar! Já existe registro nas vendas!");
                    } else {
                        alert("Ocorreu um erro ao tentar apagar o registro!");
                    }
                }, "json");
            }
        }
