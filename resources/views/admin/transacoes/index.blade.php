...
<div class="row">
    <div class="col-md-3">
        <button id="comprovanteGen" class="btn">Gerar comprovante
...
<!-- <script type="text/javascript">
   $(function() {
       ...
       $('#transations-table tbody').on('click', 'button', function() {
           ...
           $("#modalHeader").html('<h4>Deseja realmente cancelar está venda?</h4>');
       ...
       function submitF() {
           ...
           $("#modalBody").html("Processando o pedido aguarde");
